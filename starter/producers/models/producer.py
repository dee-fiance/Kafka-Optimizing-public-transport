...
class Producer:
    ...
    def __init__(
        ...
        self.producer = AvroProducer(
            self.broker_properties,
            default_key_schema=self.key_schema, # default_key_schema
            default_value_schema=self.value_schema # default_value_schema
        )
    ...
    def create_topic(self):
        ...
        logger.info("Creating a new topic %s.", self.topic_name)
